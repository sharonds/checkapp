  ...
  return (
    <div>
      ...
      <Prose>
        ...
        <p>
          Each check produces a score from 0 to 100 and a verdict of pass,
          warn, fail, or skipped. Skipped checks are excluded from the overall
          score; if every enabled check is skipped, the overall score is N/A.
        </p>
      </Prose>
...
function SkillsReference() {
  const skills = [
    ...
    {
      name: "AI Detection",
      engine: "Copyscape / Gemini",
      cost: "~$0.03 / ~$0.01",
      desc: "Analyzes writing patterns to estimate the likelihood that content was generated by an AI model. Copyscape is the default English-only provider; Gemini is available when explicitly configured for multilingual checks.",
    },
    {
      name: "SEO Analysis",
      engine: "Offline",
...
function ScoreGuide() {
  return (
    <div>
      ...
      <Prose>
        <p>
          Each assessed skill produces an independent score from 0 to 100. The
          overall check score is calculated as the arithmetic average of
          non-skipped enabled skill scores. When no enabled skill is assessed,
          the overall score is N/A.
        </p>
      </Prose>
...
function ApiKeysSetup() {
  return (
    <div>
      ...
      <Prose>
        <p>Required for Plagiarism Check and for AI Detection when Copyscape is the selected provider.</p>
      </Prose>
