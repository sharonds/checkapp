...
Instead, open a [GitHub issue](https://github.com/sharonds/checkit/issues) with the title prefix `[security]` — this flags it for private review.
...
- **Credentials** are stored locally at `~/.checkit/config.json`. They are only sent to `www.copyscape.com` over HTTPS.
